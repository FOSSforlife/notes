...
<details><summary>Other popular DAWs besides Ableton and REAPER</summary>
<p>

- [FL Studio](https://www.image-line.com), [Bitwig Studio](https://www.bitwig.com/) for loop-based/electronic music
- [Logic Pro](https://www.apple.com/logic-pro/), [Studio One](https://www.presonus.com/products/Studio-One) for a more linear workflow
	- Recently Logic has released a clip launcher feature which is supposed to be similar to Ableton, although I haven't tried it yet.
- [Pro Tools](https://www.avid.com/pro-tools) is what you'll almost certainly be using if you are taking college courses or plan on working in a professional studio. If those don't apply to you, I wouldn't recommend this one.
- [Cakewalk](https://www.bandlab.com/products/cakewalk) and [Ardour](https://ardour.org) are free, which I guess is cool. A good DAW is a worthwhile investment though, so you should be willing to shell out some cash.
...
There are thousands of tutorials on YouTube that show you how to make a mix from start to finish and explain various techniques. I'd recommend checking these out, and also doing some of your own searching:
