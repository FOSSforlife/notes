...
- A DAW (digital audio workstation). There is no correct DAW to use. These all have different workflows, each with their own pros and cons, so download the free demos and choose what you like the most.
  - My personal favorites:
    ...
    - [Ableton Live](https://www.ableton.com) (Mac, Windows) - Excellent for sound design and live performance. Extremely popular with electronic musicians, both professionals and hobbyists. Where it exceeds Bitwig: its collection of high-quality, professional-sounding synths, effects, and samples (over 70 GB!), plus it's easier to collaborate with others and receive tips and presets from the internet because everyone uses it. Where it lags behind Bitwig: it's more expensive, doesn't have Linux support, and its modular patching environment (Max for Live) is much more daunting.
  - Some others you may want to consider:
    - [Bitwig Studio](https://www.bitwig.com/) (Mac, Windows, Linux) - Used to be my go-to for jamming and sound design. Use this if you're into making your own sounds. It comes with a [modular patching environment called The Grid](https://www.youtube.com/watch?v=-wHHbV8Zw4g), which is more intuitive and fun to use than all of the comparable tools out there.
...
- [FakeSmileRevolution - Mixing Metal Guitar](https://www.youtube.com/watch?v=A2C_VR_ppDA)

### Bass

- [iZotope - Tips For Mixing Bass](https://www.youtube.com/watch?v=BWED_GSBEL4)
...
- [REAPER Blog - Mean Bass Tone Using Stock Plugins in REAPER](https://www.youtube.com/watch?v=oyrEjRu_U5Y&list=PL4mhaIEnflCBNTGK6Ggxsy-oJDANa1-Kt&index=98&t=0s)
